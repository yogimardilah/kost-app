...
class RolePermissionController extends Controller
{
    ...
    private function getAvailableMenus()
    {
        return [
            ...
            'purchases' => 'Operasional',
            'payrolls' => 'Payroll',
            'laporan' => 'Laporan',
            'reports_occupancy' => 'Laporan Hunian',
            'reports_finance' => 'Laporan Keuangan',
            'reports_revenue_daily' => 'Chart Pendapatan Harian',
            'reports_revenue_monthly' => 'Chart Pendapatan Bulanan',
            'reports_traffic' => 'Chart Traffic In/Out',
            'manajemen' => 'Manajemen',
            'users' => 'Users',
            'roles' => 'Roles',
