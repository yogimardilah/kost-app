            ...
            <form method="POST" action="{{ route('purchases.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="description" id="description" class="form-control @error('description') is-invalid @enderror" 
                           value="{{ old('description') }}" placeholder="Misal: Pembelian Cat Dinding" required>
                ...
                <div class="form-group">
                    ...
                    <select name="category" id="category" class="form-control @error('category') is-invalid @enderror" required>
                        ...
                        <option value="perbaikan" {{ old('category') === 'perbaikan' ? 'selected' : '' }}>Perbaikan</option>
                        <option value="pembelian_barang" {{ old('category') === 'pembelian_barang' ? 'selected' : '' }}>Pembelian Barang</option>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="amount" id="amount" class="form-control @error('amount') is-invalid @enderror" 
                           value="{{ old('amount') }}" placeholder="0" step="0.01" required>
